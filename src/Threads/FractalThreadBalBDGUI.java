 ...
 * @author afons
 */
public class FractalThreadBalBDGUI extends Thread{
//descrição das vvariaveis mais premonorizada no contrutor
    ...
    public FractalThreadBalBDGUI(AtomicInteger colunasI, int tamanhoH, int tamanhoV, double maxC, double minC, double iteracoes, BigDecimal centroX, BigDecimal centroY, BigDecimal zoom, double mini, String fra, String col, double [][] graf, MathContext mc, ProgressReporter reporter) {
        super();
