 ...
 * @author afons
 */
public class FractalThreadColunasParBD extends Thread{
    ...
    public FractalThreadColunasParBD(int tamanhoH, int tamanhoV, int linhaMin, int linhaMax, int colunaMin, int colunaMax, double maxC, double minC, double iteracoes, BigDecimal centroX, BigDecimal centroY, BigDecimal zoom, double mini, String fra, String col, PixelWriter graf, MathContext mc, ProgressReporter reporter) {
        super();
